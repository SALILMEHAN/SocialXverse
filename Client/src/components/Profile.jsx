        ...
        <div className='w-[50%] border-l border-r border-gray-200'>
            <div>
                ...
                <div className='absolute top-52 ml-2 border-4 border-white rounded-full'>
                    <Avatar src={`${profile?.avatar}`} size="120" round={true} />
                </div>
                <div className='text-right m-4'>
                    {
                        profile?._id === user?._id ? (
                            <button className='px-4 py-1 hover:bg-gray-200 rounded-full border border-gray-400'><NavLink to={"/edit"}>Edit Profile</NavLink></button>
