...
const LeftSideBar = () => {
    ...
    return (
        <div className='w-[20%]'>
            <div>
                <div>
                    <img className='ml-5' width={"80px"} src="https://res.cloudinary.com/duwxtwter/image/upload/v1718710866/socialx_verse_l7ul5w_c_crop_w_330_h_250_vs294t.jpg" alt="socialXverse-logo" />
                </div>
                <div className='my-4'>
                    ...
                    <Link to={'/'} ><button className='px-4 py-2 border-none text-md bg-[#1D9BF0] w-full rounded-full text-white font-bold'>Post</button></Link>
                </div>
            </div>
        </div>
    )
