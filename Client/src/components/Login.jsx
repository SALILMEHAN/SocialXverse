    ...
    return (
        <div className='w-screen h-screen flex items-center justify-center'>
            <div className='flex items-center justify-evenly w-[80%]'>
                <div>
                    <img className='ml-5' width={"500px"} src="https://res.cloudinary.com/duwxtwter/image/upload/v1718710866/socialx_verse_l7ul5w_c_crop_w_330_h_250_vs294t.jpg" alt="socialXverse-logo" />
                </div>
                <div>
                    <div className='my-5'>
